...
<nav class="relative flex h-20 w-full items-center bg-[#1e1e1e] px-4 py-4 text-white">
	<div
		class="font-[Arial Black] absolute left-1/2 -translate-x-1/2 transform text-4xl leading-none font-extrabold tracking-wide"
	>
		<span class="text-white">GenX</span>
	</div>

	<div
		class="settings-icon relative ml-auto cursor-pointer"
		role="button"
		tabindex="0"
	...
	>
		...
		{#if dropdownOpen}
			<div
				class="dropdown absolute right-0 z-10 mt-2 w-64 rounded-lg bg-[#333333] text-white shadow-lg"
				role="menu"
			>
				<div class="border-b border-gray-500 px-4 py-2 text-center text-lg font-semibold">
					Settings
				</div>

				<a
					href="/configuration"
					class="flex items-center justify-center rounded-lg px-4 py-2 hover:bg-gray-600"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						class="mr-2 h-5 w-5"
				...
				<a
					href="https://github.com/muhammad-fiaz/GenX/issues/new"
					class="flex items-center justify-center rounded-lg px-4 py-2 hover:bg-gray-600"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
					...
					>
						<path
							d="M5 9a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v5a7 7 0 0 1-7 7v0a7 7 0 0 1-7-7V9Zm3-3v-.425c0-.981.384-1.96 1.326-2.238c1.525-.45 3.823-.45 5.348 0C15.616 3.615 16 4.594 16 5.575V6m2.5 1.5L22 4M5.5 7.5L2 4m4 14l-4 3m3-9H1.5m21 0H19m-1 6l4 3m-10-8v8"
						/>
					</svg>

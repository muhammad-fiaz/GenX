...
<header
	class="flex h-8 items-center justify-between border-b border-white/10 bg-[#1b1b1b] px-3 shadow-inner select-none"
...
>
	...
	>
		...
		<div class="titlebar-menu relative z-20">
			<button
				type="button"
				class="btn-control flex items-center gap-1 rounded px-2 py-1 hover:bg-gray-700"
				aria-haspopup="true"
			...
			{#if openMenu === 'file'}
				<ul
					class="absolute left-0 mt-1 w-40 rounded-md border border-[#444] bg-[#232323] py-1 text-sm shadow-lg"
					role="menu"
					tabindex="-1"
				>
					<li>
						<a
							href="/"
							class="block cursor-pointer px-4 py-2 hover:bg-gray-700"
							role="menuitem"
							tabindex="0">New File</a
						>
					</li>
					<li>
						<a
	...
	<div class="ml-auto flex space-x-1">
        ...
        hover:bg-gray-700 focus-visible:bg-gray-700"
			...
			title="Minimize"
		>
			<svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-white" viewBox="0 0 24 24"
